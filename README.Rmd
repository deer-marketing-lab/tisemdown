...
This project is a modified version Chester Ismay's {thesisdown} package to provide support for Tilburg School of Economics and management Students to adhere to thesis formatting guidelines.

This project provides a template for writing a thesis in R Markdown, and rendering those files into a PDF formatted according to [the requirements of Tilburg University](FIXME).  
